...
static MoveResult freecell_validate_to_foundation(Freecell *freecell,
                                                  Card card) {
...
static MoveResult freecell_validate_to_reserve(Freecell *freecell, Card card,
...
static MoveResult freecell_validate_to_cascade_single(Freecell *freecell,
                                                      Card card,
                                                      SelectionLocation dest) {
...
static MoveResult freecell_validate_to_cascade(Freecell *freecell, Move move) {
...
static MoveResult freecell_validate_move(Freecell *freecell, Move move) {
...
static void freecell_move_to_foundation(Freecell *freecell, Card card) {
  Card *foundation = &freecell->foundation[get_suit(card)];
  *foundation = card;
}

static void freecell_move_to_reserve(Freecell *freecell, Card card,
                                     SelectionLocation dest) {
  freecell->reserve[dest - RESERVE_1] = card;
}

static void freecell_move_to_cascade_single(Freecell *freecell, Card card,
                                            SelectionLocation dest) {
  Cascade *cascade = &freecell->cascade[dest - CASCADE_1];
  freecell_push_cascade(cascade, card);
}

static void freecell_move_to_cascade(Freecell *freecell, Move move) {
  Cascade *from_cascade = &freecell->cascade[move.from];
  Cascade *to_cascade = &freecell->cascade[move.to];
...
static void freecell_move(Freecell *freecell, Move move) {
  bool from_cascade = selection_location_is_cascade(move.from);
  bool to_cascade = selection_location_is_cascade(move.to);
